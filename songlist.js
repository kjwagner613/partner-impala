document.addEventListener("DOMContentLoaded", () => {
  ...
  function useHorizontalArtistRow() {
    return libraryBrowseMode !== "video";
  }
  ...
  function syncSongListModeClass() {
    ...
    const useHorizontalArtistRow = libraryBrowseMode !== "video";
    libraryCurrentList.classList.toggle("library-artists-row", useHorizontalArtistRow);
    libraryCurrentList.classList.toggle("is-vertical-artist-list", !useHorizontalArtistRow);
  }
  ...
  function renderLibraryPanel() {
    customLibraryPanel.hidden = false;
    updateLibraryModeButtons();
    syncSongListModeClass();
    renderLibraryPath();
  ...
  function renderPlaylistPanel() {
    ...
    const playlist = getCurrentPlaylist();
    songList.innerHTML = "";
    playlistTitle.textContent = "Playlist Editor";
